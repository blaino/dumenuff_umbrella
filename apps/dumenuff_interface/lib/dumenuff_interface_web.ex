defmodule DumenuffInterfaceWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: DumenuffInterfaceWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/dumenuff_interface_web/templates",
        namespace: DumenuffInterfaceWeb
